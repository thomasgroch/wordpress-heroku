...
class WC_Correios_Shipping extends WC_Shipping_Method {
	...
	public function __construct() {
		...
		$this->service_envio_facil= $this->get_option( 'service_envio_facil' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'service_envio_facil' => array(
				'title'            => __( utf8_encode('Envio Fácil'), 'woocommerce-correios' ),
				'type'             => 'checkbox',
				'label'            => __( 'Enable', 'woocommerce-correios' ),
				'description'      => __( 'Shipping via Envio facil.', 'woocommerce-correios' ),
				'desc_tip'         => true,
				'default'          => 'no'
			),
	...
	protected function correios_services() {
		...
		$services['ENVIOFACIL'] = ( 'yes' == $this->service_envio_facil ) ? '1' : '';
